...
namespace Composer
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            project.InsertPitchedNote(2, new Project.FretboardNote { StringNo = 0, Fret = 3, timeRange = new TimeRange(256 / 4 * 1, 256 / 4) });
            project.InsertPitchedNote(2, new Project.FretboardNote { StringNo = 0, Fret = 5, timeRange = new TimeRange(256 / 4 * 3, 256 / 4) });
            project.InsertPitchedNote(2, new Project.FretboardNote { StringNo = 0, Fret = 3, timeRange = new TimeRange(256 / 4 * 5, 256 / 4) });
