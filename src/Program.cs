...
namespace Composer
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            project.tracks.Add(new Project.TrackFretboardNotes("Guitar 1", Tuning.Standard, "Nylon2"));
            project.tracks.Add(new Project.TrackFretboardNotes("Guitar 2", Tuning.Standard, "Guitar2"));
            project.tracks.Add(new Project.TrackFretboardNotes("Bass", Tuning.BassStandard, "Ugk"));
