...
namespace NAudioWpfDemo.DrumMachineDemo
{
    class DrumKit
    {
        ...
        public DrumKit()
        {
            var kickSample = SampleSource.CreateFromWaveFile("AudioOut\\Drums\\kick-trimmed.wav");
            var snareSample = SampleSource.CreateFromWaveFile("AudioOut\\Drums\\snare-trimmed.wav");
            var closedHatsSample = SampleSource.CreateFromWaveFile("AudioOut\\Drums\\closed-hat-trimmed.wav");
            var openHatsSample = SampleSource.CreateFromWaveFile("AudioOut\\Drums\\open-hat-trimmed.wav");
